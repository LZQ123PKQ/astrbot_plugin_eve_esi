...
class EVEESITester:
    ...
    def _build_result(self, item_info, skill_bonuses_dict, unique_bonuses_list, attr_dict, item_name_cn):
        ...
        skill_order = [
            # 精英护卫舰
            '突击护卫舰操作', '截击舰操作', '隐形特勤舰操作', '电子攻击舰操作', '后勤护卫舰操作',
            # 基础护卫舰
            '艾玛护卫舰操作', '加达里护卫舰操作', '盖伦特护卫舰操作', '米玛塔尔护卫舰操作',
            # 驱逐舰
            '艾玛驱逐舰操作', '加达里驱逐舰操作', '盖伦特驱逐舰操作', '米玛塔尔驱逐舰操作',
            # 精英巡洋舰
            '重型突击巡洋舰操作', '重型拦截巡洋舰操作', '侦察舰操作', '后勤巡洋舰操作',
            # 基础巡洋舰
            '艾玛巡洋舰操作', '加达里巡洋舰操作', '盖伦特巡洋舰操作', '米玛塔尔巡洋舰操作',
            # 战列巡洋舰
            '艾玛战列巡洋舰操作', '加达里战列巡洋舰操作', '盖伦特战列巡洋舰操作', '米玛塔尔战列巡洋舰操作',
            # 战列舰
            '艾玛战列舰操作', '加达里战列舰操作', '盖伦特战列舰操作', '米玛塔尔战列舰操作',
        ]
